    ...
    >
      ...
      >
        <div>
          ...
          {/* The scope line is gone, not rewritten.

              It said «На мапі — лише ті справи, які ми вже опрацювали», which
              was true of a map whose marks were cases. This one has no cases
              on it: it draws the states whose courts hear these proceedings,
              and the number beside a court is the registry's own — all of
              them, not the eight that have a write-up. The sentence could not
              survive the change, and there is nothing it needed to be replaced
              with: a drawing that no longer makes a claim about coverage does
              not need a line qualifying one. */}
        </div>
