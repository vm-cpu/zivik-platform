...
/**
 * "About the Library" text, verbatim (bilingual) from the source materials.
 * Full name: The Library of Accountability and Justice for Ukraine 'NaSvitlo'.
 */
export const about: AboutContent = {
  ...
  paragraphs: {
    uk: [
      "Бібліотека відповідальності та правосуддя для України «НаСвітло» — це онлайн-колекція міжнародної судової практики, що стосується низки українських ініціатив для притягнення Росії до відповідальності за агресивну війну проти України. Протиправний характер дій Росії був визнаний Генеральною Асамблеєю ООН ще в березні 2014 року в резолюції, яка наголошувала на незаконності «референдуму» в Криму та закликала всі держави, міжнародні організації і спеціалізовані установи не визнавати жодних змін його статусу.",
    ...
    en: [
      "The Library of Accountability and Justice for Ukraine ‘NaSvitlo’ is an online collection of international case-law concerning the various initiatives launched by Ukraine to hold Russia accountable for its war of aggression. The unlawful character of Russia’s actions was recognized by the UN General Assembly as early as March 2014, in a resolution underscoring the illegality of the ‘referendum’ in Crimea and calling upon all States, international organizations, and specialized agencies not to recognize any alteration of its status.",
