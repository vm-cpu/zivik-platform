  ...
  verdicts: [
    {
      ...
      claim: {
        uk: "(b) Росія не може вживати проти України жодних заходів за Конвенцією на підставі хибних тверджень про геноцид",
        en: "(b) Russia cannot lawfully take any action under the Convention against Ukraine on the basis of its false claims of genocide",
      },
      outcome: "granted",
    },
    {
      track: "Genocide Convention",
      claim: {
        uk: "(c) Визнання «ДНР» і «ЛНР» не має підстав у Конвенції про геноцид",
        en: "(c) The recognition of the “DPR” and “LPR” has no basis in the Genocide Convention",
      },
      outcome: "rejected",
    },
    {
      track: "Genocide Convention",
      claim: {
        uk: "(d) «Спеціальна воєнна операція» не має підстав у Конвенції про геноцид",
        en: "(d) The “special military operation” has no basis in the Genocide Convention",
      },
      outcome: "rejected",
    },
  ],
    ...
    items: [
      {
        ...
        outcome: "rejected",
        reasoning: {
          uk: "Суд розглянув спір у двох аспектах і встановив: спір між сторонами існував — щонайменше щодо того, чи вчинила Україна геноцид.",
          en: "The Court examined the dispute in two aspects and found that a dispute did exist between the Parties — at least as to whether Ukraine had committed genocide.",
        },
      ...
      },
      {
        ...
        outcome: "upheld",
        reasoning: {
          uk: "Єдине заперечення, яке спрацювало. Застосування сили й визнання держав є зовнішніми щодо Конвенції про геноцид, тож вимоги (c) і (d) Меморандуму випадають зі справи.",
          en: "The one objection that worked. The use of force and the recognition of States are extrinsic to the Genocide Convention, so submissions (c) and (d) of the Memorial fall out of the case.",
        },
        votes: [
          {
            for: 12,
      ...
      },
      {
        ...
        outcome: "rejected",
        reasoning: {
          uk: "Суд не побачив підміни предмета спору: вимоги Меморандуму не перетворюють спір, з яким Україна прийшла до Суду.",
          en: "The Court saw no substitution of the subject of the dispute: the submissions in the Memorial do not transform the dispute Ukraine brought.",
        },
        votes: [
      ...
      },
      {
        ...
        outcome: "rejected",
        reasoning: {
          uk: "Суд відхилив аргумент: рішення визначить права сторін за Конвенцією і врегулює спір між ними.",
          en: "The Court rejected the argument: a judgment would settle the parties' rights under the Convention and resolve the dispute between them.",
        },
      ...
      },
      {
        ...
        outcome: "rejected",
        reasoning: {
          uk: "Найважливіше для майбутніх справ: держава може просити Суд встановити, що вона не порушувала договір. Саме на цьому тримається позов України.",
          en: "The finding that matters most for future cases: a State may ask the Court to declare that it did not breach a treaty. Ukraine's whole claim rests on it.",
        },
      ...
      },
      {
        ...
        outcome: "rejected",
        reasoning: {
          uk: "Суд не знайшов виняткових обставин, які виправдали б відмову у розгляді на цій підставі.",
          en: "The Court found no exceptional circumstances that would justify rejecting the case on this ground.",
        },
        votes: [{ for: 15, against: 1 }],
      },
    ],
