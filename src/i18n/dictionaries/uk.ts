...
const uk = {
  ...
  mapSection: {
    ...
    filterCategory: "Тип порушення",
    filterForum: "Суд",
    allForums: "Усі суди",
    onlyAnalysed: "Лише з конспектом",
    reset: "Скинути",
    counter: "{shown} з {total} подій",
    empty: "Під ці фільтри не підпадає жодна подія.",
    listTitle: "Заявлені порушення",
    hint: "Оберіть подію на мапі або у списку — і побачите провадження, у яких її оцінюють.",
    proceedings: "Провадження",
    summaryLink: "Конспект",
    decisionLink: "Текст рішення",
    inRegistry: "Уся бібліотека →",
    noDocument: "Текст ще не опубліковано",
    offMap: "Поза мапою",
    seatsTitle: "Суди в цьому місті",
    placeHead: "Місце",
    placeArea: "територія, не точка",
    placeBasis: "за матеріалами",
    proceedingsFew: "провадження",
    proceedingsMany: "проваджень",
    inLibrary: "у бібліотеці",
    hubRegistry: "Показати в бібліотеці →",
    zoomIn: "Наблизити",
    zoomOut: "Віддалити",
    zoomReset: "Уся мапа",
    close: "Закрити",
    unmapped:
      "Ще {n} проваджень не привʼязані до точки на мапі — їх видно через суд або в бібліотеці.",
    litBadge: "конспект",
    loading: "Мапа завантажується…",
  },
  registry: {
