...
const uk = {
  ...
  hero: {
    ...
    sub: "35 проваджень проти РФ: від Міжнародного суду ООН і ЄСПЛ до ордерів ICC і морських арбітражів.",
  ...
  registry: {
    ...
    queuedNote: "Внесено до реєстру · конспект у підготовці",
    legendLit: "Опрацьоване рішення: конспект, таймлайн, документи",
    legendQueued: "У черзі: внесено, конспект у підготовці",
    statusDecided: "Рішення",
    statusProgress: "У розгляді",
    statusWarrant: "Ордери",
    statusQueued: "TBD",
  },
  newsletter: {
